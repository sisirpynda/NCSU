...
//sis - added for project 4 value prediction
extern uint64_t PERF_VAL_PRED; 
extern uint64_t predINTALU;
extern uint64_t predFPALU;
extern uint64_t predLOAD;

// sis - inputs to svp predictor
extern uint64_t VPQsize      ;
extern uint64_t oracleconf   ;
extern uint64_t index_bits   ;
extern uint64_t tag_bits     ;
extern uint64_t confmax      ;
